...
namespace Shizuku.Graph
{
    using Shizuku.Core;
    [Serializable]
    [NodeMenuItem("获取/Int", NodeCategory.Variable, Description = "获取整数变量")]
    ...
    [Serializable]
    [NodeMenuItem("获取/Float", NodeCategory.Variable, Description = "获取浮点数变量")]
    ...
    [Serializable]
    [NodeMenuItem("获取/Bool", NodeCategory.Variable, Description = "获取布尔变量")]
    ...
    [Serializable]
    [NodeMenuItem("获取/String", NodeCategory.Variable, Description = "获取字符串变量")]
    ...
    [Serializable]
    [NodeMenuItem("获取/Vector2", NodeCategory.Variable, Description = "获取Vector2变量")]
    ...
    [Serializable]
    [NodeMenuItem("获取/Vector3", NodeCategory.Variable, Description = "获取Vector3变量")]
    ...
    [Serializable]
    [NodeMenuItem("获取/GameObject", NodeCategory.Variable, Description = "获取GameObject变量")]
    ...
    [Serializable]
    [NodeMenuItem("获取/Transform", NodeCategory.Variable, Description = "获取Transform变量")]
    ...
    [Serializable]
    [NodeMenuItem("获取/Color", NodeCategory.Variable, Description = "获取Color变量")]
