...
namespace Shizuku.Graph
{
    using Shizuku.Core;
    [Serializable]
    [NodeMenuItem("变量/Get Int", Description = "获取整数变量")]
    ...
    [Serializable]
    [NodeMenuItem("变量/Get Float", Description = "获取浮点数变量")]
    ...
    [Serializable]
    [NodeMenuItem("变量/Get Bool", Description = "获取布尔变量")]
    ...
    [Serializable]
    [NodeMenuItem("变量/Get String", Description = "获取字符串变量")]
    ...
    [Serializable]
    [NodeMenuItem("变量/Get Vector2", Description = "获取Vector2变量")]
    ...
    [Serializable]
    [NodeMenuItem("变量/Get Vector3", Description = "获取Vector3变量")]
    ...
    [Serializable]
    [NodeMenuItem("变量/Get GameObject", Description = "获取GameObject变量")]
    ...
    [Serializable]
    [NodeMenuItem("变量/Get Transform", Description = "获取Transform变量")]
    ...
    [Serializable]
    [NodeMenuItem("变量/Get Color", Description = "获取Color变量")]
